...
#     """
#     Skeleton defination and forward kinematics for H36M.
#     We add virtual collar since there's no collar or shoulder in H36M.
#     """

#     def __init__(self):
#         """
#         original_segments = ['Hips','RightUpLeg','RightLeg','RightFoot',
#                             'LeftUpLeg','LeftLeg','LeftFoot',
#                             'Spine','Spine3','Neck',
#                             'LeftArm','LeftForeArm','LeftHand', 
#                             'RightArm','RightForeArm','RightHand']
            
#         new_segments = ['Hips','RightUpLeg','RightLeg','RightFoot',
#                         'LeftUpLeg','LeftLeg','LeftFoot',
#                         'Spine','Spine3','Neck',
#                         'LeftCollar', 'LeftArm', 'LeftForeArm','LeftHand', 
#                         'RightCollar', 'RightArm','RightForeArm','RightHand']            
            
#         parents = ['None', 'Hips', 'RightUpLeg', 'RightLeg', 
#                     'Hips', 'LeftUpLeg', 'LeftLeg', 
#                     'Hips', 'Spine', 'Spine3', 
#                     'Spine3', 'LeftArm', 'LeftForeArm',
#                     'Spine3', 'RightArm', 'RightForeArm']    
#         """
#         self.offsets =  [None,
#                         [ 0.        , -0.08811617,  0.        ],
#                         [ 0.        ,  0.        , -0.29354303],
...
#         self.topology = [-1, 0, 1, 2, 0, 4, 5, 0, 7, 8, 8, 10, 11, 12, 8, 14, 15, 16]
...
#     def forward_kinematics(self, orientation, to_smpl=True, to_mvnx=True):
#         positions = super().forward_kinematics(orientation, to_smpl, to_mvnx)
#         return positions, self.connections    
    
    
# if __name__ == '__main__':    
#     from aitviewer.renderables.skeletons import Skeletons
#     from aitviewer.viewer import Viewer
#     sk_smpl = SMPLSkeleton()
#     sk_xsens = XsensSkeleton()
    
#     k3d_smpl = sk_smpl.forward_kinematics(torch.eye(3).repeat(100, 24, 1, 1))
#     k3d_xsens = sk_xsens.forward_kinematics(torch.eye(3).repeat(100, 23, 1, 1))
        
#     smpl_skeleton = Skeletons(
#                     k3d_smpl.numpy(),
#                     sk_smpl.connections,
#                     radius=0.015,
#                     gui_affine=False,
...
#     xsens_skeleton = Skeletons(
#                 k3d_xsens.numpy(),
#                 sk_xsens.connections,
#                 gui_affine=False,
#                 radius=0.015,
#                 color=(100 / 255, 177 / 255, 177 / 255, 1.0),
#                 name="xsens Skeleton",
#             )   
...
#     v.scene.add(smpl_skeleton)
#     v.scene.add(xsens_skeleton)   
#     v.run()   